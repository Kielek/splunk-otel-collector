...
PKG_NAME="splunk-otel-envvar-auto-instrumentation"

CONFIG_INSTALL_PATH="/usr/lib/systemd/system.conf.d/00-splunk-otel-auto-instrumentation.conf"
CONFIG_REPO_PATH="${CUR_DIR}/00-splunk-otel-auto-instrumentation.conf"
PROFILE_INSTALL_PATH="/etc/profile.d/00-splunk-otel-auto-instrumentation.sh"
PROFILE_REPO_PATH="${CUR_DIR}/00-splunk-otel-auto-instrumentation.sh"
PROPERTIES_INSTALL_PATH="/usr/lib/splunk-instrumentation/splunk-otel-javaagent.properties"
PROPERTIES_REPO_PATH="${CUR_DIR}/splunk-otel-javaagent.properties"
